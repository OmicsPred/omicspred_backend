# Generated by Django 4.2 on 2023-07-06 11:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='EFO',
            fields=[
                ('id', models.CharField(max_length=30, primary_key=True, serialize=False, verbose_name='EFO ID')),
                ('label', models.CharField(db_index=True, max_length=500, verbose_name='EFO Label')),
                ('description', models.TextField(null=True, verbose_name='EFO Description')),
                ('url', models.CharField(max_length=500, verbose_name='EFO URL')),
                ('type', models.CharField(max_length=100, null=True, verbose_name='Entry type')),
                ('child_efos', models.ManyToManyField(related_name='parent_efos', to='omicspred.efo', verbose_name='Children EFO')),
            ],
        ),
        migrations.CreateModel(
            name='Gene',
            fields=[
                ...
                ('synonyms', models.JSONField(null=True, verbose_name='Gene synonyms')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_released', models.DateField(db_index=True, null=True, verbose_name='OmicsPred Release Date')),
                ('curation_notes', models.TextField(default='', verbose_name='Curation Notes')),
                ('genes', models.ManyToManyField(related_name='gene_score', to='omicspred.gene', verbose_name='Gene(s)')),
                ('metabolites', models.ManyToManyField(related_name='metabolite_score', to='omicspred.metabolite', verbose_name='Metabolite(s)')),
                ...
                ('proteins', models.ManyToManyField(related_name='protein_score', to='omicspred.protein', verbose_name='Protein(s)')),
                ...
                ('transcripts', models.ManyToManyField(related_name='transcript_score', to='omicspred.transcript', verbose_name='Transcript(s)')),
            ],
        ),
        migrations.CreateModel(
            name='Sample',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('curation_notes', models.TextField(default='', verbose_name='Curation Notes')),
                ('efo', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='efo_performance', to='omicspred.efo', verbose_name='Peformance EFO')),
                ('platform', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='platform_performance', to='omicspred.platform', verbose_name='Peformance Platform')),
                ...
                ('score', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='score_performance', to='omicspred.score', verbose_name='Score')),
            ],
        ),
        migrations.CreateModel(
            name='Metric',
        ...
        migrations.AddField(
            ...
            name='pathway_group',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='pathway_group_metabolite', to='omicspred.pathway', verbose_name='Associated Pathway Group'),
        ),
        migrations.AddField(
            model_name='metabolite',
            name='pathway_subgroup',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='pathway_subgroup_metabolite', to='omicspred.pathway', verbose_name='Associated Pathway Subgroup'),
        ),
    ]
